...
class FORMAT
{
	...
	// for self interface to get the img server url and replace the attach tag in text by anxiang.xiao 20150827
	public static function parse_attachs2($str, $get_attachs_id = false)
	{
		if ($get_attachs_id)
		{
			preg_match_all('/\[attach\]([0-9]+)\[\/attach]/', $str, $matches);
		...
		{
			return preg_replace_callback('/\[attach\]([0-9]+)\[\/attach\]/i', 'parse_attachs_callback_2', $str);
		}
	}

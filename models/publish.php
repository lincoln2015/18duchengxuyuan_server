...
class publish_class extends AWS_MODEL
{
	...
	// add for insert the item_id by anxinag.xiao 20150829
	public function add_attach_2($item_type, $file_name, $attach_access_key, $add_time, $file_location, $is_image = false,$item_id)
	{
		if ($is_image)
		{
			$is_image = 1;

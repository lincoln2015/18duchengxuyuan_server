...
class answer_class extends AWS_MODEL
{
	...
	// add for focus in update_answer_content by anxiang.xiao 20150829
	public function update_answer_content($answer_id, $answer_content)
	{
		$answer_id = intval($answer_id);
	...
	{
		return $this->fetch_all('answer_comments', "answer_id = " . intval($answer_id), "time DESC ");
	}

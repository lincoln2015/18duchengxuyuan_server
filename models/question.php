...
{
	// add for focus in update_answer_content by anxiang.xiao 20150908
	...
	public function update_question_detail($question_id, $question_detail)
	{
		...
		return $this->update('question', $data, 'question_id = ' . intval($question_id));
	}
